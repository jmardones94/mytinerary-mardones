  ...
  return (
    <BrowserRouter>
      ...
      <Switch>
        ...
        <Route path="/cities" render={() => <Cities citiesData={citiesData}/>}></Route>
        <Route path="/itineraries/:id" render={({ match }) => <City city={citiesData.find(c => c._id === parseInt(match.params.id))} />} />
