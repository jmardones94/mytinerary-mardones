...
const Footer = () => {
    ...
    return (
        <footer className="select-none transition duration-1000 w-100 min-h-56 py-5 text-gray-900 dark:text-white bg-gray-200 dark:bg-black flex flex-wrap justify-center md:justify-evenly items-center">
            <ul className="w-1/3 pt-3 md:pt-5 md:w-1/6 md:pl-10 order-1">
                <li className="font-medium hover:underline cursor-pointer">
                    <Link to="/">
                        <span className="inline-block h-3 w-1 bg-yellow-500 mr-1"></span>
                        Home
                    </Link>
                </li>
                <li className="font-medium hover:underline cursor-pointer">
                    <Link to="/cities">
                        <span className="inline-block h-3 w-1 bg-pink-500 mr-1"></span>
                        Cities
                    </Link>
                </li>
                <li className="font-medium hover:underline cursor-pointer">
            ...
            <div className="w-full md:w-1/3 md:order-2 mt-4 order-last text-center">
                <Link to="/">
                    <h2 className="tracking-wider text-5xl mb-5 font-medium font-silt">
                        MyTinerary
                    </h2>
                </Link>
            ...
            <div className="w-1/3 md:w-1/6 md:px-5 lg:px-10 order-3">
                ...
                <ul>
                    {socials.map((social) => {
                        ...
                        return (
                            <li
                                className="font-semibold flex justify-between my-1"
                                key={social}
                            >
                                <a
