...
const Footer = () => {
    ...
    return(
        <footer className="w-100 min-h-56 py-5 text-black dark:text-white bg-gray-500 dark:bg-black flex flex-wrap justify-center md:justify-evenly items-center">
            <ul className="w-1/3 pt-3 md:pt-5 md:w-1/6 md:pl-10 order-1">
                ...
                <li className="hover:underline cursor-pointer"><Link to="/signup"><span className="inline-block h-3 w-1 bg-purple-500 mr-1"></span>Sign Up</Link></li>
