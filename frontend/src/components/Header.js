...
const Header = () => {
    ...
    return(
    <nav className="transition duration-1000 w-100 h-32 py-5 md:h-28 px-5 md:px-20 flex flex-wrap justify-between md:items-center text-gray-900 bg-blue-500 dark:text-white dark:bg-black">
        ...
        <div className="w-screen md:w-3/5 flex justify-between mt-3 md:mt-0">
            <div className="flex gap-4 items-center md:pl-16 md:gap-5 font-semibold md:text-lg">
                ...
                <NavLink className="cities hover:text-pink-500" to="/cities">Cities</NavLink>
            </div>
            <div className="md:mr-3 flex items-center gap-3 md:gap-5">
                <span className="cursor-pointer w-8 h-8 hover:text-yellow-300" onClick={themeClickHandler}>
                    {theme === 'dark'
