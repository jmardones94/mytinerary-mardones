...
const Hero = ({heroImg}) => {
    return(
        <div className={`dark:bg-gray-900 md:h-4/5s max-w-screen transition duration-1000 flex flex-col md:flex-row gap-2 md:gap-5 justify-end items-center px-5 md:pl-20 md:pr-8`}>
